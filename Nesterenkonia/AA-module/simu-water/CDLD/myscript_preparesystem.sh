...
sed -i "s/CDLC/$molecule/g" step_eq1.mdp
sed -i "s/CDLC/$molecule/g" step_eq2.mdp
sed -i "s/CDLC/$molecule/g" step_eq3.mdp
sed -i "s/CDLC/$molecule/g" step_eq4.mdp
sed -i "s/CDLC/$molecule/g" step_prod.mdp
