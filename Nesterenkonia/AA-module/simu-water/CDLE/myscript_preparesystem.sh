...
sed -i "s/CDLD/$molecule/g" step_eq1.mdp
sed -i "s/CDLD/$molecule/g" step_eq2.mdp
sed -i "s/CDLD/$molecule/g" step_eq3.mdp
sed -i "s/CDLD/$molecule/g" step_eq4.mdp
sed -i "s/CDLD/$molecule/g" step_prod.mdp
...
$EXE solvate -cp system_mini.gro -cs spc216.gro -p topol.top -o system_sol.gro -maxsol 16904 -scale 0.56
