...
#####################CG
EXE=gmx_mpi
NATOM=15  #number of beads
mfile=mapping_PI_16_A15.ndx

seq 0 $NATOM | $EXE traj -s ../AA_massfix.tpr -f ../system_prod.xtc -n $mfile -com -ng $NATOM -oxt traj_AA2CG.xtc -pbc yes

seq 0 $NATOM | $EXE traj -s ../AA_massfix.tpr -f ../system_prod.gro -n $mfile -com -ng $NATOM -oxt PILA_cg.gro -pbc yes
