...
EXE=gmx_mpi
###########SOLVATE
copy CDLA_cg.gro from AA-module/simu-water/CDLA/analysis/

$EXE editconf -f CDLA_cg.gro -box 10.1 10.1 10.1 -center 5.05 5.05 5.05 -o CDLA_cg_fix.gro 

$EXE solvate -cp CDLA_cg_fix.gro -cs water.gro -p topol.top -o system.gro -maxsol 8716  2>&1 |tee  out1.txt   
