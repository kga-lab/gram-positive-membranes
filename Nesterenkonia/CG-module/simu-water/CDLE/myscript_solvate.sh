...
EXE=gmx_mpi
###########SOLVATE
#copy CDLE_cg.gro from AA-module/simu-water/CDLE/analysis/

$EXE editconf -f CDLE_cg.gro -box 10.1 10.1 10.1 -center 5.05 5.05 5.05 -o CDLE_cg_fix.gro 

$EXE solvate -cp CDLE_cg_fix.gro -cs water.gro -p topol.top -o system.gro -maxsol 8716  2>&1 |tee  out1.txt   
