...
EXE=gmx_mpi
###########SOLVATE
copy PGLA_cg.gro from AA-module/simu-water/PGLA/analysis/

$EXE editconf -f PGLA_cg.gro -box 10 10 10 -center 5 5 5 -o PGLA_cg_fix.gro 

$EXE solvate -cp PGLA_cg_fix.gro -cs water.gro -p topol.top -o system.gro -maxsol 8715  2>&1 |tee  out1.txt   
