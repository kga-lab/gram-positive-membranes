...
while [ $IBOND -lt $NBONDS ]; do
   echo $IBOND | $EXE distance -f ../system_prod.xtc -n $filendx -oall $DIR/bond_$IBOND.xvg  &> $DIR/temp_bonds.txt -oh $DIR/histbond_$IBOND.xvg -len 0.6 -binw 0.010
    ...
    #$EXE analyze -f $DIR/bond_$IBOND.xvg -dist $DIR/histbond_$IBOND.xvg -xvg none -bw 0.002
