...
!======================================================================!
             ...
             open(20,file='DAGX-timeline-neighborfractions-lower.dat')
             open(21,file='PGLD-timeline-neighborfractions-lower.dat')
             open(22,file='CDLX-timeline-neighborfractions-lower.dat')
             open(23,file='neighborfractions-lower.dat') !!timeaveraged
             favgt(:,:)=0.0
             do ite=1,maxit
               read(12,'(a)') dummy
               read(12,*) N
            ...
            do i=1,Nm
             ...
             do k=1,Nm
                  co(:,:)=0
                 if((resnam(k).eq.'DAGX')) ip=1
                 if((resnam(k).eq.'PGLD')) ip=2
                 if((resnam(k).eq.'CDLX')) ip=3
                 lip(ip)=lip(ip)+1
              do j=1,5
                 if((resnam(jnew(k,j)).eq.'DAGX')) jp=1
                 if((resnam(jnew(k,j)).eq.'PGLD')) jp=2
                 if((resnam(jnew(k,j)).eq.'CDLX')) jp=3
                 co(ip,jp)=co(ip,jp)+1
               enddo!j
